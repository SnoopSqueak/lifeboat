...
static MunitResult test_init_str_charcount (const MunitParameter params[],
                                            void * data) {
        int count = 5;
        struct lb_str *str;
        munit_assert_int(init_str_charcount(&str, &count), ==, 0);
...
static MunitResult test_init_str_chars (const MunitParameter params[],
                                        void * data) {
        const char *val = "Hello, world!";
        struct lb_str *str;
        munit_assert_int(init_str_chars(&str, val), ==, 0);
...
static MunitResult test_comp_str_str (const MunitParameter params[],
        ...
        int iseql;
        munit_assert_int(init_str_chars(&str1, val1), ==, 0);
        munit_assert_int(init_str_chars(&str2, val2), ==, 0);
        munit_assert_int(init_str_chars(&str3, val1), ==, 0);
...
static MunitResult test_str_ins_str (const MunitParameter params[],
        ...
        munit_assert_int(init_str_charcount(&str_a, &acount), ==, 0);
        munit_assert_not_null(str_a->chars);
        munit_assert_int(init_str_chars(&str_b, "Hello"), ==, 0);
...
static MunitResult test_str_cat_str (const MunitParameter params[],
        ...
        int nullcount = 1;
        struct lb_str *str1, *str2, *nullstr;
        munit_assert_int(init_str_chars(&str1, val1), ==, 0);
        munit_assert_int(init_str_chars(&str2, val2), ==, 0);
        munit_assert_int(init_str_charcount(&nullstr, &nullcount), ==, 0);
        munit_assert_string_equal(nullstr->chars, "");
        ...
        munit_assert_int(str_cat_str(str1, nullstr), ==, 0);
        munit_assert_string_equal(str1->chars, "Hello, world!");
        munit_assert_int(str_cat_str(nullstr, str2), ==, 0);
        munit_assert_string_equal(str2->chars, nullstr->chars);
        munit_assert_int(free_str(&str1), ==, 0);
        munit_assert_int(free_str(&str2), ==, 0);
        munit_assert_int(free_str(&nullstr), ==, 0);
        return MUNIT_OK;
};

static MunitResult test_init_str_int (const MunitParameter params[],
                                      void * data) {
        int src = 365;
        struct lb_str *str;
        munit_assert_int(init_str_int(&str, &src), ==, 0);
...
static MunitResult test_str_del_charcount (const MunitParameter params[],
        ...
        munit_assert_int(init_str_chars(&str, "Hello, cruel world!"), ==, 0);
...
static MunitResult test_str_del_all (const MunitParameter params[],
                                     void * data) {
        struct lb_str *str;
        munit_assert_int(init_str_chars(&str, "Hello, world!"), ==, 0);
...
static MunitTest lb_str_tests[] = {
        {(char*) "/init/str/charcount", test_init_str_charcount, NULL, NULL,
                MUNIT_TEST_OPTION_NONE, NULL},
        {(char*) "/init/str/chars", test_init_str_chars, NULL, NULL,
                MUNIT_TEST_OPTION_NONE, NULL},
        ...
        {(char*) "/str/cat/str", test_str_cat_str, NULL, NULL,
                MUNIT_TEST_OPTION_NONE, NULL},
        {(char*) "/init/str/int", test_init_str_int, NULL, NULL,
                MUNIT_TEST_OPTION_NONE, NULL},
